        ...
        <div className="fixed inset-0 z-50 flex min-h-full items-center justify-center bg-black/80 backdrop-blur-sm">
            <div className="flex min-h-full items-center justify-center text-center">
                <div className="relative">
                    ...
                    <div className="max-w-[300px] overflow-hidden rounded-[20px] bg-gradient-to-r from-primary via-secondary to-tertiary
 px-4 pb-8 pt-[70px] text-center transition-all md:max-w-[600px] md:px-32 md:pb-9">
                        <h1 className="max-w-sm text-center text-xl font-bold text-white">
                            Want to Like? Please log in to Instagram.
                        </h1>
