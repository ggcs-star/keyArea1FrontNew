...
const Overview = ({ 
  ...
  // Priority: URL param > project._id > project.id > project.projectId > project.slug
  const projectId = urlProjectId || project?._id || project?.id || project?.projectId || project?.slug || null;
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">{project?.project_type || project?.type || 'N/A'}</p>
              </div>
            </li>
                ...
                <p className="font-semibold text-sm text-gray-800">
                  {Array.isArray(bhkUnits) && bhkUnits.length > 0 ? (
                    bhkUnits.map((unit, index) => (
                      <span key={index}>
                        {unit.name || `${unit.bhk} BHK` || unit.bhkType || 'N/A'}
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">{totalPrice?.price || project?.price || 'N/A'}</p>
              </div>
            </li>
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">
                  {project?.possession_date || (Array.isArray(bhkUnits) && bhkUnits.length > 0 ? bhkUnits[0]?.date : null) || 'N/A'}
                </p>
              </div>
            </li>
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">{project?.total_units ? `${project.total_units} units` : "80 units"}</p>
              </div>
            </li>
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">{totalSize?.carpet_area || project?.carpet_area || totalSize?.size || 'N/A'}</p>
              </div>
            </li>
            ...
            <li className="flex items-center p-3">
              ...
              <div>
                ...
                <p className="font-semibold text-sm text-gray-800">{project?.project_status || project?.phase || 'N/A'}</p>
              </div>
            </li>
          </ul>
        </div>
