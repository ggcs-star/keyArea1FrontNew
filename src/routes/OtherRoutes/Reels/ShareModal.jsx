...
const ShareModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-end justify-center z-50">
      <div 
        ref={modalRef}
        className={`my-8 bg-white rounded-t-2xl p-6 w-full sm:w-[400px] relative transition-all duration-300 ease-in-out ${isClosing ? 'translate-y-full' : 'translate-y-0'}`}
        style={{ 
      ...
      >
        ...
        <h2 className="text-xl font-axiformaBold font-bold">Share</h2>
        <h2 className="text-md my-2 font-axiformaMedium">Share the link via</h2>
        ...
        <h2 className="text-md my-2 font-axiformaMedium">Or Copy Link</h2>
