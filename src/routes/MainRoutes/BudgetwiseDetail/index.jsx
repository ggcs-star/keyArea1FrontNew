...
const BudgetwiseDetail = () => {
  ...
  // Fix for inconsistent scrolling
        ...
        {loading ? (
          ...
          <nav className="py-2 text-sm text-gray-500 mb-4">
            <ol className="flex">
              ...
              <li>
                <Link to="/budgetwise/1" className="text-red-500">
                  Budgetwise
                </Link>{" "}
                /{" "}
              </li>
  ...
  {loading ? <OverviewShimmer /> : (
    <Overview
      project={project}
      projectId={id} // Pass the ID from useParams directly
      builder={builder}
      totalPrice={totalPrice}
      totalSize={totalSize}
      bhkUnits={bhkUnits}
    />
          ...
          <div className="sticky top-24 md:w-1/3">
            ...
            <video
              ...
              controls
              muted
              className="w-full rounded-lg h-[600px] mb-4 shadow"
            />
...
export default BudgetwiseDetail;
